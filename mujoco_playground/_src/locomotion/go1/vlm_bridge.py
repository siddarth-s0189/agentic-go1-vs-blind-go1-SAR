          ...
          messages=[
              {
                  ...
                  "content": (
                      ...
                      "For lateral movement (vel_y), use NEGATIVE values to "
                      "move LEFT and POSITIVE values to move RIGHT. This is "
                      "your primary way to sidestep obstacles. "
                      "- Temporal Awareness: IMPORTANT: You are controlling a "
                      "robot in a high-latency loop. Every command you issue "
                      "will be executed for exactly 1.2 seconds (60 physics "
                      "steps) before you receive your next visual update. "
                      "At a forward velocity (vel_x) of 0.8, the robot will "
                      "travel approximately 1 meter before you see again. Look "
                      "at the grid/rubble in the Birds-Eye View and ensure "
                      "your chosen speed won't carry you into an obstacle "
                      "within that 1-meter window. Before deciding, imagine "
                      "where the robot will be in 1.2 seconds. If a gap is "
                      "narrow or an obstacle is close, use lower velocities "
                      "(0.2 to 0.4) to maintain fine control. Use high "
                      "velocities (0.8+) ONLY when the Birds-Eye View shows "
                      "a clear path for at least 2 meters. "
